...
public class JFrameUsuario extends JFrame{
	...
	public JFrameUsuario(Usuario usuario) {
		...
		//JBUTTONs/JLABELs/JTABLEs/...
			...
			imagen = new JLabel(new ImageIcon(new ImageIcon("images/usuario.png").getImage().getScaledInstance(100, 100, Image.SCALE_DEFAULT)));
